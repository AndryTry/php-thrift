...
include_once $GLOBALS['THRIFT_ROOT'].'/Exception/TException.php';
include_once $GLOBALS['THRIFT_ROOT'].'/Exception/TTransportException.php';
include_once $GLOBALS['THRIFT_ROOT'].'/Protocol/TProtocol.php';
include_once $GLOBALS['THRIFT_ROOT'].'/Transport/TTransport.php';
include_once $GLOBALS['THRIFT_ROOT'].'/Type/TType.php';
include_once $GLOBALS['THRIFT_ROOT'].'/Type/TMessageType.php';
include_once $GLOBALS['THRIFT_ROOT'].'/Factory/TStringFuncFactory.php';
include_once $GLOBALS['THRIFT_ROOT'].'/StringFunc/TStringFunc.php';
include_once $GLOBALS['THRIFT_ROOT'].'/StringFunc/Core.php';
